        ...
        $("#jaxSettle").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '도메인ID', datafield: 'domainuid', displayField: 'domainuid', align: "center" , cellsalign: "center" ,width: '0%', hidden:true},
                    { text: '회원아이디', datafield: 'email', displayField: 'email', align: "center" , cellsalign: "left" , editable: false, width: '8%'},
                    { text: '도메인명', datafield: 'domainname', displayField: 'domainname', align: "center" , cellsalign: "center" , editable: false, width: '3%'},
                    { text: '사업장명', datafield: 'businessname', displayField: 'businessname', align: "center" , cellsalign: "center" , editable: false, width: '8%'},
                    { text: '대표자명', datafield: 'representationname', align: "center" ,cellsalign: "center" , width: '5%'},
